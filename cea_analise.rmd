...
```{r, include=FALSE}
library(readxl)
data_anual = read_xlsx("C:\\Users\\Rodrigo Araujo\\Documents\\IME-USP\\CEA 1\\dados\\Cadeia-Ano.xlsx")
```
...
acf(z_bov, main = "ACF da Bovinocultura")
...
acf(z_pesc, main = "ACF do Pescado")
...
acf(z_avc, main = "ACF da Avicultura de Corte")
...
acf(z_suino, main = "ACF da Suinocultura")
